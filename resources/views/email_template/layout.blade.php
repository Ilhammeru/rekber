                    ...
                    <tbody>
                        ...
                        <tr style="background-color:#e0e0e0;height:120px;">
                            <td style="padding:50px 30px;">
                                <p style="text-align:center;font-size:1.2em;margin:0px;padding:0px;margin-bottom:15px;font-weight:bold;">{{ \App\Models\Setting::where('key', 'company_name')->first()->value }}</p>
                                <p style="text-align:center;padding:0px;"><?= str_replace('<br />', ', ', nl2br( \App\Models\Setting::where('key', 'company_address')->first()->value)) ?></p>
                                <p style="text-align:center;padding:0px;">&copy;<?= date('Y'); ?> - <a href="{{ url('/') }}">{{ \App\Models\Setting::where('key', 'app_name')->first()->value }}</a></p>
                            </td>
                        </tr>
                    </tbody>
                </table>
